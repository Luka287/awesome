...
globalkeys = gears.table.join(
   ...
   awful.key({}, "Scroll_Lock", function() 
	   awful.spawn(string.format("i3lock-fancy"))
	end,
   {description="Locks screen", group="hotkeys"}),
   ...
   {description = "screenshot", group = "hotkeys"}),
    ...
    awful.key({ modkey, crtl }, "j", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen", group = "screen"}),
    awful.key({ modkey, crtl }, "k", function () awful.screen.focus_relative(-1) end,
    ...
    awful.key({ modkey, crtl }, "h",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, crtl }, "l",     function () awful.tag.incncol(-1, nil, true)    end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, crtl }, "space",  awful.client.floating.toggle                     ,
              {description = "toggle floating", group = "client"}),
    awful.key({ modkey, crtl }, "Return", function (c) c:swap(awful.client.getmaster()) end,
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, crtl, "Shift" }, "#" .. i + 9,
                  function ()
                      if client.focus then
                          local tag = client.focus.screen.tags[i]
                          if tag then
...
-- Screenlock
awful.spawn.with_shell("xss-lock i3lock-fancy")
awful.spawn.with_shell("xset s 180")
